...
![](HealthAnalytics_files/figure-gfm/numerical%20variable-1.png)<!-- -->

``` r
hist(dados$AGE_DON)
```

![](HealthAnalytics_files/figure-gfm/numerical%20variable-2.png)<!-- -->

``` r
hist(dados$PTIME)
```

![](HealthAnalytics_files/figure-gfm/numerical%20variable-3.png)<!-- -->

``` r
hist(dados$ï..DAYSWAIT_CHRON)
```

![](HealthAnalytics_files/figure-gfm/numerical%20variable-4.png)<!-- -->

``` r
hist(dados$FINAL_MELD_SCORE)
```

![](HealthAnalytics_files/figure-gfm/numerical%20variable-5.png)<!-- -->
...
Correlação entre as variáveis numéricas Para variáveis categóricas
usamos associação:
...
![](HealthAnalytics_files/figure-gfm/correlation%20matrix-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-gfm/validation%20error-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-gfm/error%20validation-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-gfm/histogram%20unscale%20data-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-gfm/neural%20network%20plot-1.png)<!-- -->
