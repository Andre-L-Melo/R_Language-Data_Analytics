...
![](HealthAnalytics_files/figure-html/numerical variable-1.png)<!-- -->

```r
hist(dados$AGE_DON)
```

![](HealthAnalytics_files/figure-html/numerical variable-2.png)<!-- -->

```r
hist(dados$PTIME)
```

![](HealthAnalytics_files/figure-html/numerical variable-3.png)<!-- -->

```r
hist(dados$ï..DAYSWAIT_CHRON)
```

![](HealthAnalytics_files/figure-html/numerical variable-4.png)<!-- -->

```r
hist(dados$FINAL_MELD_SCORE)
```

![](HealthAnalytics_files/figure-html/numerical variable-5.png)<!-- -->
...
![](HealthAnalytics_files/figure-html/correlation matrix-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-html/validation error-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-html/error validation-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-html/histogram unscale data-1.png)<!-- -->
...
![](HealthAnalytics_files/figure-html/neural network plot-1.png)<!-- -->
